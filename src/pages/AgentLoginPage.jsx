  ...
  return (
    <div className="animate-fade-in bg-background-light min-h-[85vh] font-display text-charcoal flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="border-2 shadow-lg border-blue-500 p-8 bg-white">
          <div className="text-center mb-8 flex flex-col items-center">
            <span className="material-symbols-outlined text-5xl text-blue-500 mb-3">
              support_agent
            </span>
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-6">
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                required
                className="w-full p-4 bg-surface-subtle border-2 border-charcoal/10 focus:border-blue-500 focus:outline-none font-mono text-lg text-center transition-all"
              />
            </div>
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-blue-500 text-white py-4 font-black uppercase tracking-[0.2em] text-sm hover:bg-charcoal transition-all cursor-pointer disabled:opacity-50"
            >
              {loading ? 'WAIT...' : 'LOGIN'}
            </button>
        ...
        <div className="mt-8 text-center opacity-20">
          <p className="font-mono text-[9px] uppercase tracking-[0.3em]">
            SYSTEM_PROTOCOL // AGENT_TERMINAL
          </p>
        </div>
      </div>
    </div>
